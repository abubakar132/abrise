  ...
  return (
    <>
        ...
        <div className="container">
          <div className="hero-inner">
            ...
            <div>
              ...
              <p className="hero-p">
                I'm Abu Bakar. I build <strong>high-converting websites and client systems enhanced with AI features</strong> for coaches and consultants, whether you need a brand-new website or want to improve your existing one.
              </p>
            ...
            <div className="hero-mockup">
              ...
              <div className="mockup-frame">
                <div className="mockup-bar">
                  ...
                  <div className="url-bar">abrise.tech | AI Demo</div>
                </div>
      ...
      <section className="vsl-section">
        <div className="container">
          <div className="vsl-wrap reveal">
            <div className="section-tag">Watch First</div>
            <h2 className="section-headline" style={{ fontSize: 'clamp(1.8rem, 2.8vw, 2.4rem)', marginBottom: 10 }}>
              Quick Walkthrough Before You Apply
            </h2>
            <p style={{ color: 'var(--text-muted)', marginBottom: 20 }}>
              Watch this short video to see how Abrise combines strategic website positioning with AI features to help you get better-qualified leads.
            </p>
            <div className="vsl-frame">
              <iframe
                src="https://www.youtube.com/embed/aoE3qBLyJEM?si=4HhuqkINYrhxT-yT"
                title="Abrise Video Sales Letter"
                loading="lazy"
      ...
      <section className="features-section" id="features">
        <div className="container">
          ...
          <p className="reveal" style={{ fontSize: '1.05rem', color: 'var(--text-muted)', fontWeight: 300, lineHeight: 1.7, maxWidth: 560, marginBottom: 0 }}>
            Whether you're starting fresh or upgrading an existing site, Abu Bakar builds the full stack: design, AI features, and automation.
          </p>
          ...
          <div className="features-grid">
            {[
              ...
              { ico: '📅', title: 'Smart Booking Flow', desc: 'Once a lead is qualified, the system guides them straight to a booking with no emails back-and-forth and no "let me know what time works for you." Zero friction discovery calls, booked automatically.' },
      ...
      <section className="how-section" id="how">
        <div className="container">
          ...
          <div className="how-grid">
            {[
              { n: '01', title: 'Strategic Audit', desc: 'Tell Abu Bakar about your coaching business and your situation, new site needed or existing one to upgrade. He personally reviews and identifies your biggest opportunity.' },
              { n: '02', title: 'Custom System Build', desc: 'Abu Bakar designs and builds your landing page or upgrade with an AI chatbot, booking flow, and lead capture tailored to your coaching niche and offer.' },
              { n: '03', title: 'AI Features Go Live', desc: 'Aria, your AI assistant, starts engaging visitors, qualifying leads, and routing serious prospects to your Calendly. It works 24/7, even while you sleep.' },
      ...
      <section className="proof-section" id="proof">
        <div className="container">
          ...
          <div className="proof-grid">
            {[
              { init: 'SL', name: 'Sarah L.', role: 'Business Coach, Dubai', stars: 5, quote: 'I never knew a website could actually book clients for me. The AI chatbot filters every lead so I only talk to people who can pay. My close rate went from 20% to 65% in a month.', image: '/assets/testimonial-sarah.jpg' },
              { init: 'MR', name: 'Marcus R.', role: 'Fitness & Mindset Coach', stars: 5, quote: 'Abu Bakar built my site from scratch. Within 2 weeks I had 8 discovery calls booked, all pre-qualified. My old Wix site got maybe 1 call a month. Completely different world.', image: '/assets/testimonial-marcus.jpg' },
              { init: 'AK', name: 'Amira K.', role: 'Life & Relationship Coach', stars: 5, quote: "I already had a site but it wasn't converting. Abu Bakar upgraded it with the AI chatbot and booking flow. Now it actually works. I stopped chasing leads entirely.", image: '/assets/testimonial-amira.jpg' },
            ].map((t) => (
              <div key={t.name} className="testi reveal">
                ...
                <div className="testi-auth">
                  <div className="testi-av-wrap">
                    ...
                    />
                    <div className="testi-av" style={{ display: 'none' }}>{t.init}</div>
                  </div>
                  <div>
      ...
      <section className="audit-section" id="audit">
        ...
        <div className="container">
          <div className="audit-wrap">
            <div className="section-tag" style={{ display: 'inline-flex' }}>Personal Audit</div>
            <h2 className="reveal" style={{ fontFamily: 'Playfair Display, serif', fontWeight: 900, fontSize: 'clamp(2rem, 3vw, 2.8rem)', color: '#FAFAF5', marginBottom: 12 }}>
              Get Abu Bakar's Personal<br />
              <em style={{ color: 'var(--gold)' }}>AI Growth Direction</em>
            </h2>
            <p className="reveal" style={{ fontSize: '1rem', color: 'var(--text-muted)', fontWeight: 300, lineHeight: 1.7, marginBottom: 0 }}>
              Whether you need a new website or want to upgrade your existing one, fill this in and Abu Bakar will personally review your setup and send you one specific growth idea that could get you more booked calls.
            </p>
